...
![homepage](https://github.com/user-attachments/assets/91f8a5a4-2f93-4c7f-9d04-65a7c8238cb7)
...
<div id="indexPage" style="outline:0" data-role="page" data-dom-cache="true"
  ...
  <style>
    .featurediframe {
      ...
      margin: 0 auto; margin-bottom: -41vh; margin-top: -3.5em;
    ...
    @media (max-width: 421px) and (orientation: portrait) {
      .featurediframe { height: 100vh; margin-bottom: -55vh; margin-top: -6.5em; }
    }
    @media (max-height: 421px) and (orientation: landscape) {
      .featurediframe { height: 100vh; margin-bottom: -25vh; margin-top: -6.5em; }
    }
  </style>
